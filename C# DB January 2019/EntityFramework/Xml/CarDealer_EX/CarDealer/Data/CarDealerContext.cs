namespace CarDealer.Data
{
    ...
    public class CarDealerContext : DbContext
    {
        ...
        private void ApplyConfiguration(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.ApplyConfiguration(new PartEntityConfiguration());

            modelBuilder.ApplyConfiguration(new PartCarEntityConfiguration());

            modelBuilder.ApplyConfiguration(new SaleEntityConfiguration());

            modelBuilder.ApplyConfiguration(new SupplierEntityConfigration());
        }
    }
}
